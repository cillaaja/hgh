...
def main():
    ...
    st.title("🎥 Streaming YouTube Live (Upload Cepat + URL Besar)")
    ...
    video_url = st.text_input("🌐 Atau masukkan URL video langsung (contoh: https://.../video.mp4)")
    ...
    # Gunakan video lokal yang dipilih
    elif selected_video:
